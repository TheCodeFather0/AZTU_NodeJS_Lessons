...
const baseUI_mjs_1 = __importDefault(require('./baseUI.js'));
...
function fetchAsyncQuestionProperty(question, prop, answers) {
    ...
    return (0, rxjs_1.from)((0, run_async_1.default)(value)(answers).then((value) => {
        question[prop] = value;
        return question;
    }));
}
 ...
 */
class PromptsRunner extends baseUI_mjs_1.default {
    ...
    run(questions, answers) {
        ...
        if (Array.isArray(questions)) {
            ...
            obs = (0, rxjs_1.from)(Object.entries(questions).map(([name, question]) => {
                ...
                return Object.assign(Object.assign({}, question), { name });
            }));
        }
        else {
    ...
    processQuestion(question) {
        ...
        return (0, rxjs_1.defer)(() => {
            ...
            return obs.pipe((0, rxjs_1.concatMap)(this.setDefaultType.bind(this)), (0, rxjs_1.concatMap)(this.filterIfRunnable.bind(this)), (0, rxjs_1.concatMap)((question) => fetchAsyncQuestionProperty(question, 'message', this.answers)), (0, rxjs_1.concatMap)((question) => 
            // @ts-expect-error question type is too loose
            fetchAsyncQuestionProperty(question, 'default', this.answers)), (0, rxjs_1.concatMap)((question) => 
            // @ts-expect-error question type is too loose
            fetchAsyncQuestionProperty(question, 'choices', this.answers)), (0, rxjs_1.concatMap)((question) => {
                // @ts-expect-error question type is too loose
